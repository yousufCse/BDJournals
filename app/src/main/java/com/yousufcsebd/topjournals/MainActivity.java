...
import com.yousufcsebd.topjournals.adapter.NavDrawerListAdapter;
import com.yousufcsebd.topjournals.model.NavDrawerItem;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Home
        navDrawerItems.add(new NavDrawerItem(navMenuTitles[0], navMenuIcons.getResourceId(0, -1), true, "26"));
        // Online
        ...
        mDrawerToggle = new ActionBarDrawerToggle(this, mDrawerLayout,
                ...
                R.string.app_name // nav draer close - description for accessibility
        ) {
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        menu.findItem(R.id.m_eixt).setVisible(!drawerOpen);
...
//                fragment = new AboutActivity();
                startActivity(new Intent(Intent.ACTION_VIEW,
                        Uri.parse("https://play.google.com/store/apps/developer?id=Apps+Hole+Ltd.")));
                break;
